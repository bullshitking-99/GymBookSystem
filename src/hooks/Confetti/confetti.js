...
// import { set_confetti } from "./hooks/Confetti/confetti"; // 可以正常使用，但会报ts模块引入错误

// 组件挂载后可为元素增加confetti特效，但使用.click()自动触发会导致位置偏移至左上角
// onMounted(() => {
//   set_confetti("boom");
// });
*/
...
function set_confetti(id) {
  // Pass in the id of an element
  let confetti = new Confetti(id);
